  ...
  return (
    <div>
      <h1 className="sr-only">
        Hello I&apos;m Arman Hossen, I&apos;m a software developer, and I love building things for
        the web.
      </h1>
      ...
      <canvas
        id="canvas"
        className="pointer-events-none absolute inset-0 -z-10 bg-white dark:bg-black"
      />
    </div>
  );
}
